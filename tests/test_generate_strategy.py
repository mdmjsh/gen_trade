...
def test_choose_indicator():
    ...
    assert generate_strategy.choose_indicator(indicators, 1, same_class_indicators) == mockInd
    ...
    assert generate_strategy.choose_indicator(indicators, 1, same_class_indicators) == fakeInd


@patch("generate_strategy.choose_indicator")
def test_generate(choose_indicator):
