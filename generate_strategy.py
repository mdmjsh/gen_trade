...
def choose_indicator(indicators, max_same_class, same_class_indicators):
    ...
    if same_class_indicators.get(indicator['type'], -1) + 1 > max_same_class:
        ...
        return choose_indicator(_indicators, max_same_class,
...
def make_strategy_from_indicators(indicators: Sequence,
    ...
    return dict(id=str(uuid.uuid4()),
                ...
                conjunctions=[
                    ...
                    for _ in range(len(indicators) - 1)
                ])


def generate(base_indicator,
             indicators,
             conjunctions=CONJUNCTIONS,
    ...
    strategy = dict(id=str(uuid.uuid4()),
    ...
    for i in range(num_indicators - 1):
        ...
        ind = choose_indicator(indicators, max_same_class,
                               same_class_indicators)
...
def main():
    ...
    parser.add_argument('--population_size',
                        ...
                        required=False)
    parser.add_argument('--max_indicators',
                        type=int,
    ...
    for _ in range(args.population_size):
        ...
        strategies.append(
            generate(base_indicator, indicators, CONJUNCTIONS,
                     args.max_indicators, args.max_same_class))
    return strategies
